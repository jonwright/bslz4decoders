...
int omp_lz4_blocks ( const char *, size_t, int, int, uint32_t *, int, char *, size_t );
/* Signature for onecore_ipp_func */
int onecore_ipp ( const char *, size_t, int, char *, size_t );
...
size_t h5_read_direct ( int64_t dataset_id, int frame, char * chunk, size_t chunk_length ){
...
int omp_lz4 ( const char * compressed, size_t compressed_length, int itemsize, char * output, size_t output_length ){
...
int omp_lz4_blocks ( const char * compressed, size_t compressed_length, int itemsize, int blocksize, uint32_t * blocks, int blocks_length, char * output, size_t output_length ){
/* begin: omp_lz4 */
...
/* Definition for onecore_ipp_func */
int onecore_ipp ( const char * compressed, size_t compressed_length, int itemsize, char * output, size_t output_length ){
/* begin: chunks_2_blocks */
...
int onecore_lz4 ( const char * compressed, size_t compressed_length, int itemsize, char * output, size_t output_length ){
/* begin: chunks_2_blocks */
...
int print_offsets ( const char * compressed, size_t compressed_length, int itemsize ){
/* begin: chunks_2_blocks */
...
int read_starts ( const char * compressed, size_t compressed_length, int itemsize, int blocksize, uint32_t * blocks, int blocks_length ){
/* begin: read_starts */
