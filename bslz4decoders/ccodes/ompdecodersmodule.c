 ...
 * Generation date: Fri Jul 23 16:37:24 2021
...
/*frompyobj*/
  ...
  /* Processing variable num_threads */
    f2py_success = int_from_pyobj(&num_threads,num_threads_capi,"ompdecoders.omp_bslz4() 4th argument (num_threads) can't be converted to int");
  if (f2py_success) {
...
#endif
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOOOO|:ompdecoders.omp_bslz4_blocks",\
...
/*frompyobj*/
  ...
  /* Processing variable num_threads */
    f2py_success = int_from_pyobj(&num_threads,num_threads_capi,"ompdecoders.omp_bslz4_blocks() 6th argument (num_threads) can't be converted to int");
  if (f2py_success) {
  /* Processing variable compressed_length */
  compressed_length = len(compressed);
