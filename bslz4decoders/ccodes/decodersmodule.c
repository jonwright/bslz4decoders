...
/* See f2py2e/rules.py */
extern int onecore_lz4(unsigned_char*,long_long,int,unsigned_char*,long_long);
extern int print_offsets(unsigned_char*,long_long,int);
extern int read_starts(unsigned_char*,long_long,int,int,unsigned*,int);
/*eof externroutines*/
...
static PyObject *f2py_rout_decoders_read_starts(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           int (*f2py_func)(unsigned_char*,long_long,int,int,unsigned*,int)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
