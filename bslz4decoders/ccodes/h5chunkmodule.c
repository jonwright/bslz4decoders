...
/*frompyobj*/
  ...
  /* Processing variable dsetname */
    f2py_success = signed_char_from_pyobj(&dsetname,dsetname_capi,"h5chunk.h5_open_dset() 2nd argument (dsetname) can't be converted to signed_char");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
...
/*frompyobj*/
  /* Processing variable hname */
    f2py_success = signed_char_from_pyobj(&hname,hname_capi,"h5chunk.h5_open_file() 1st argument (hname) can't be converted to signed_char");
  if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
