...
/* See f2py2e/rules.py */
extern int onecore_bslz4(unsigned_char*,long_long,int,unsigned_char*,long_long,unsigned_char*,long_long);
...
onecore_bslz4 = onecore_bslz4(compressed,itemsize,output,tmp)\n\nWrapper for ``onecore_bslz4``.\
\n\nParameters\n----------\n"
...
static PyObject *f2py_rout_ippdecoders_onecore_bslz4(const PyObject *capi_self,
                           ...
                           int (*f2py_func)(unsigned_char*,long_long,int,unsigned_char*,long_long,unsigned_char*,long_long)) {
...
/*decl*/
  ...
  static char *capi_kwlist[] = {"compressed","itemsize","output","tmp",NULL};
...
f2py_start_clock();
  ...
  if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
    "OOOO|:ippdecoders.onecore_bslz4",\
    capi_kwlist,&compressed_capi,&itemsize_capi,&output_capi,&tmp_capi))
    return NULL;
/*frompyobj*/
  ...
  if (capi_tmp_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : ippdecoders_error,"failed in converting 4th argument `tmp' of ippdecoders.onecore_bslz4 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  tmp_length = len(tmp);
  CHECKSCALAR(len(tmp)>=tmp_length,"len(tmp)>=tmp_length","hidden tmp_length","onecore_bslz4:tmp_length=%ld",tmp_length) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
...
/*callfortranroutine*/
  ...
  onecore_bslz4_return_value = (*f2py_func)(compressed,compressed_length,itemsize,output,output_length,tmp,tmp_length);
