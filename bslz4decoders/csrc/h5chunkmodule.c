...
extern long_long h5_open_dset(long_long,signed_char*);
extern int h5_close_file(long_long);
extern long_long h5_open_dset(long_long,signed_char*);
extern long_long h5_open_file(signed_char*);
extern long_long h5_read_direct(long_long,int,signed_char*,long_long);
/*eof externroutines*/
...
\n\nParameters\n----------\n"
"h5file : input long\n"
"dsetname : in/output rank-1 array('b') with bounds ((dsetname_length))\n"
"\nReturns\n-------\n"
"h5_open_dset : long";
/* extern long_long h5_open_dset(long_long,signed_char*); */
static PyObject *f2py_rout_h5chunk_h5_open_dset(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           long_long (*f2py_func)(long_long,signed_char*)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
  ...
  signed_char *dsetname = NULL;
  npy_intp dsetname_Dims[1] = {-1};
  const int dsetname_Rank = 1;
  PyArrayObject *capi_dsetname_tmp = NULL;
  int capi_dsetname_intent = 0;
...
/*frompyobj*/
  ...
  dsetname_Dims[0]=(dsetname_length);
  capi_dsetname_intent |= F2PY_INTENT_INOUT|F2PY_INTENT_C;
  capi_dsetname_tmp = array_from_pyobj(NPY_BYTE,dsetname_Dims,dsetname_Rank,capi_dsetname_intent,dsetname_capi);
  if (capi_dsetname_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : h5chunk_error,"failed in converting 2nd argument `dsetname' of h5chunk.h5_open_dset to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dsetname = (signed_char *)(PyArray_DATA(capi_dsetname_tmp));
...
#endif
/*callfortranroutine*/
  h5_open_dset_return_value = (*f2py_func)(h5file,dsetname);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
  if((PyObject *)capi_dsetname_tmp!=dsetname_capi) {
    Py_XDECREF(capi_dsetname_tmp); }
  }  /*if (capi_dsetname_tmp == NULL) ... else of dsetname*/
...
\n\nParameters\n----------\n"
"hname : in/output rank-1 array('b') with bounds ((hname_length))\n"
"\nReturns\n-------\n"
"h5_open_file : long";
/* extern long_long h5_open_file(signed_char*); */
static PyObject *f2py_rout_h5chunk_h5_open_file(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           long_long (*f2py_func)(signed_char*)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/

  long_long h5_open_file_return_value=0;
  signed_char *hname = NULL;
  npy_intp hname_Dims[1] = {-1};
  const int hname_Rank = 1;
  PyArrayObject *capi_hname_tmp = NULL;
  int capi_hname_intent = 0;
...
/*frompyobj*/
  ...
  hname_Dims[0]=(hname_length);
  capi_hname_intent |= F2PY_INTENT_INOUT|F2PY_INTENT_C;
  capi_hname_tmp = array_from_pyobj(NPY_BYTE,hname_Dims,hname_Rank,capi_hname_intent,hname_capi);
  if (capi_hname_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : h5chunk_error,"failed in converting 1st argument `hname' of h5chunk.h5_open_file to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    hname = (signed_char *)(PyArray_DATA(capi_hname_tmp));
...
#endif
/*callfortranroutine*/
  h5_open_file_return_value = (*f2py_func)(hname);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
f2py_stop_call_clock();
...
/*cleanupfrompyobj*/
  if((PyObject *)capi_hname_tmp!=hname_capi) {
    Py_XDECREF(capi_hname_tmp); }
  }  /*if (capi_hname_tmp == NULL) ... else of hname*/
...
static PyObject *f2py_rout_h5chunk_h5_read_direct(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           long_long (*f2py_func)(long_long,int,signed_char*,long_long)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
...
/*frompyobj*/
  ...
  capi_chunk_tmp = array_from_pyobj(NPY_BYTE,chunk_Dims,chunk_Rank,capi_chunk_intent,chunk_capi);
  if (capi_chunk_tmp == NULL) {
    ...
    chunk = (signed_char *)(PyArray_DATA(capi_chunk_tmp));
