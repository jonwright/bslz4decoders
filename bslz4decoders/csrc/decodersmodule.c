...
/* See f2py2e/rules.py */
extern int onecore_lz4(signed_char*,long_long,int,signed_char*,long_long);
extern int print_offsets(signed_char*,long_long,int);
extern int read_starts(signed_char*,long_long,int,int,unsigned*,int);
/*eof externroutines*/
...
/******************************** onecore_lz4 ********************************/
static char doc_f2py_rout_decoders_onecore_lz4[] = "\
onecore_lz4 = onecore_lz4(compressed,itemsize,output)\n\nWrapper for ``onecore_lz4``.\
\n\nParameters\n----------\n"
...
"onecore_lz4 : int";
/* extern int onecore_lz4(signed_char*,long_long,int,signed_char*,long_long); */
static PyObject *f2py_rout_decoders_onecore_lz4(const PyObject *capi_self,
                           PyObject *capi_args,
...
/*decl*/
  ...
  int onecore_lz4_return_value=0;
...
/*frompyobj*/
  ...
  if (capi_compressed_tmp == NULL) {
    ...
    PyErr_SetString(exc ? exc : decoders_error,"failed in converting 1st argument `compressed' of decoders.onecore_lz4 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    compressed = (signed_char *)(PyArray_DATA(capi_compressed_tmp));

  /* Processing variable itemsize */
    f2py_success = int_from_pyobj(&itemsize,itemsize_capi,"decoders.onecore_lz4() 2nd argument (itemsize) can't be converted to int");
  if (f2py_success) {
  ...
  if (capi_output_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : decoders_error,"failed in converting 3rd argument `output' of decoders.onecore_lz4 to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  CHECKSCALAR(len(compressed)>=compressed_length,"len(compressed)>=compressed_length","hidden compressed_length","onecore_lz4:compressed_length=%ld",compressed_length) {
  /* Processing variable output_length */
  output_length = len(output);
  CHECKSCALAR(len(output)>=output_length,"len(output)>=output_length","hidden output_length","onecore_lz4:output_length=%ld",output_length) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
f2py_start_call_clock();
#endif
/*callfortranroutine*/
  onecore_lz4_return_value = (*f2py_func)(compressed,compressed_length,itemsize,output,output_length);
if (PyErr_Occurred())
  f2py_success = 0;
#ifdef F2PY_REPORT_ATEXIT
...
/*end of pyobjfrom*/
        ...
        capi_buildvalue = Py_BuildValue("i",onecore_lz4_return_value);
/*closepyobjfrom*/
...
static PyObject *f2py_rout_decoders_print_offsets(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           int (*f2py_func)(signed_char*,long_long,int)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
...
static PyObject *f2py_rout_decoders_read_starts(const PyObject *capi_self,
                           PyObject *capi_args,
                           PyObject *capi_keywds,
                           int (*f2py_func)(signed_char*,long_long,int,int,unsigned*,int)) {
    PyObject * volatile capi_buildvalue = NULL;
    volatile int f2py_success = 1;
/*decl*/
...
/*frompyobj*/
  ...
  /* Processing variable blocksize */
    f2py_success = int_from_pyobj(&blocksize,blocksize_capi,"decoders.read_starts() 3rd argument (blocksize) can't be converted to int");
  if (f2py_success) {
...
static FortranDataDef f2py_routine_defs[] = {
  {"onecore_lz4",-1,{{-1}},0,(char *)onecore_lz4,(f2py_init_func)f2py_rout_decoders_onecore_lz4,doc_f2py_rout_decoders_onecore_lz4},
...
PyMODINIT_FUNC PyInit_decoders(void) {
  ...
  s = PyUnicode_FromString(
    "This module 'decoders' is auto-generated with f2py (version:1.20.3).\nFunctions:\n"
"  onecore_lz4 = onecore_lz4(compressed,itemsize,output)\n"
"  print_offsets = print_offsets(compressed,itemsize)\n"
"  read_starts = read_starts(compressed,itemsize,blocksize,blocks)\n"
".");
